...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.kubectl-ptop.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".kubectl-ptop" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".kubectl-ptop")
	}
